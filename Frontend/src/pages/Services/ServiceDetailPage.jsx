...
const SERVICES_DATA = {
  'graphic-design': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$199', description: 'Growth Design Package — a coordinated set of marketing assets.', includes: ['Up to 5 coordinated assets', 'Consistent visual direction', 'Up to 2 sizes per core design where required', 'Basic image sourcing', '2 revision rounds', 'Web-ready final files'] },
    ...
    packageComparison: {
      ...
      rows: [
        { label: '1 marketing asset', values: { basic: true, growth: true, premium: true } },
        { label: '1 finished size/format', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic custom design', values: { basic: true, growth: true, premium: true } },
        { label: 'Client-provided brand assets', values: { basic: true, growth: true, premium: true } },
        { label: '1 revision round', values: { basic: true, growth: true, premium: true } },
        { label: 'Final web-ready file', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 5 coordinated assets', values: { basic: false, growth: true, premium: true } },
        { label: 'Consistent visual direction', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 sizes per core design where required', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic image sourcing', values: { basic: false, growth: true, premium: true } },
        { label: '2 revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Web-ready final files', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 12 coordinated marketing assets', values: { basic: false, growth: false, premium: true } },
        { label: 'Creative direction', values: { basic: false, growth: false, premium: true } },
        { label: 'Brand-consistent design system', values: { basic: false, growth: false, premium: true } },
        { label: 'Multiple campaign formats', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 3 revision rounds', values: { basic: false, growth: false, premium: true } },
        { label: 'Organized final files', values: { basic: false, growth: false, premium: true } },
        { label: 'Print-ready files when required', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$199', packageName: 'Growth Package', shortDescription: 'Up to 5 coordinated assets, 2 revision rounds', description: 'Growth Design Package — a coordinated set of marketing assets.', deliveryLabel: 'Shown during service selection', revisions: '2 revision rounds', includes: ['Up to 5 coordinated assets', 'Consistent visual direction', 'Up to 2 sizes per core design where required', 'Basic image sourcing', '2 revision rounds', 'Web-ready final files'] },
  ...
  'video-editing': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$299', description: 'A single longer video with professional polish.', includes: ['1 video up to 5 minutes', 'Professional editing', 'B-roll placement', 'Titles/text graphics', 'Basic motion graphics', 'Audio cleanup', 'Color correction', 'Captions', 'Up to 2 aspect ratios', '2 revision rounds'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 video up to 60 seconds', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic cuts', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic transitions', values: { basic: true, growth: true, premium: true } },
        { label: 'Text/captions', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic audio balancing', values: { basic: true, growth: true, premium: true } },
        { label: 'Client-provided footage', values: { basic: true, growth: true, premium: true } },
        { label: '1 aspect ratio', values: { basic: true, growth: true, premium: true } },
        { label: '1 revision round', values: { basic: true, growth: true, premium: true } },
        { label: 'Final exported video', values: { basic: true, growth: true, premium: true } },
        { label: '1 video up to 5 minutes', values: { basic: false, growth: true, premium: true } },
        { label: 'Professional editing', values: { basic: false, growth: true, premium: true } },
        { label: 'B-roll placement', values: { basic: false, growth: true, premium: true } },
        { label: 'Titles/text graphics', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic motion graphics', values: { basic: false, growth: true, premium: true } },
        { label: 'Audio cleanup', values: { basic: false, growth: true, premium: true } },
        { label: 'Color correction', values: { basic: false, growth: true, premium: true } },
        { label: 'Captions', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 aspect ratios', values: { basic: false, growth: true, premium: true } },
        { label: '2 revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: '1 long-form video up to 12 minutes OR up to 5 short-form videos from supplied footage', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced editing', values: { basic: false, growth: false, premium: true } },
        { label: 'Motion graphics', values: { basic: false, growth: false, premium: true } },
        { label: 'B-roll', values: { basic: false, growth: false, premium: true } },
        { label: 'Audio enhancement', values: { basic: false, growth: false, premium: true } },
        { label: 'Branded graphics', values: { basic: false, growth: false, premium: true } },
        { label: 'Multiple export formats', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 3 revision rounds', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
  ...
  'copywriting': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$299', description: 'Businesses needing multiple content pieces with keyword awareness.', includes: ['Up to 2,500 total words', 'Up to 3 content pieces/pages', 'Keyword consideration', 'CTA development', 'Headline development', 'Basic competitor/content review', '2 revision rounds'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Blog/article up to 800 words, OR short sales page, OR email copy package, OR small website-page rewrite', values: { basic: true, growth: true, premium: true } },
        { label: 'Topic research', values: { basic: true, growth: true, premium: true } },
        { label: 'Brand-tone alignment', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic SEO considerations where applicable', values: { basic: true, growth: true, premium: true } },
        { label: '1 revision round', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2,500 total words', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 3 content pieces/pages', values: { basic: false, growth: true, premium: true } },
        { label: 'Keyword consideration', values: { basic: false, growth: true, premium: true } },
        { label: 'CTA development', values: { basic: false, growth: true, premium: true } },
        { label: 'Headline development', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic competitor/content review', values: { basic: false, growth: true, premium: true } },
        { label: '2 revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 6,000 total words', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 6 pages/content pieces', values: { basic: false, growth: false, premium: true } },
        { label: 'Content strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'SEO-oriented structure where applicable', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion-focused CTA development', values: { basic: false, growth: false, premium: true } },
        { label: 'Brand voice consistency', values: { basic: false, growth: false, premium: true } },
        { label: 'Content formatting recommendations', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 3 revision rounds', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$299', packageName: 'Growth Package', shortDescription: 'Up to 2,500 words across 3 pieces, 2 revisions', description: 'Businesses needing multiple content pieces with keyword awareness.', deliveryLabel: 'Shown during service selection', revisions: '2 revision rounds', includes: ['Up to 2,500 total words', 'Up to 3 content pieces/pages', 'Keyword consideration', 'CTA development', 'Headline development', 'Basic competitor/content review', '2 revision rounds'] },
  ...
  'brand-identity': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Brand discovery questionnaire', values: { basic: true, growth: true, premium: true } },
        { label: '2 initial logo concepts', values: { basic: true, growth: true, premium: true } },
        { label: '2 revision rounds', values: { basic: true, growth: true, premium: true } },
        { label: 'Primary logo', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic color palette', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic typography recommendations', values: { basic: true, growth: true, premium: true } },
        { label: 'PNG, JPG and transparent logo files', values: { basic: true, growth: true, premium: true } },
        { label: 'Brand discovery', values: { basic: false, growth: true, premium: true } },
        { label: '3 initial logo concepts', values: { basic: false, growth: true, premium: true } },
        { label: 'Secondary logo variation', values: { basic: false, growth: true, premium: true } },
        { label: 'Icon/mark', values: { basic: false, growth: true, premium: true } },
        { label: 'Color palette', values: { basic: false, growth: true, premium: true } },
        { label: 'Typography system', values: { basic: false, growth: true, premium: true } },
        { label: 'Social profile assets', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic brand guidelines', values: { basic: false, growth: true, premium: true } },
        { label: '3 revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Organized final files', values: { basic: false, growth: true, premium: true } },
        { label: 'Brand strategy session', values: { basic: false, growth: false, premium: true } },
        { label: 'Competitive visual review', values: { basic: false, growth: false, premium: true } },
        { label: '3 refined creative directions', values: { basic: false, growth: false, premium: true } },
        { label: 'Primary and secondary logos', values: { basic: false, growth: false, premium: true } },
        { label: 'Brand mark', values: { basic: false, growth: false, premium: true } },
        { label: 'Color system', values: { basic: false, growth: false, premium: true } },
        { label: 'Brand imagery direction', values: { basic: false, growth: false, premium: true } },
        { label: 'Social assets', values: { basic: false, growth: false, premium: true } },
        { label: 'Basic business-card/letterhead templates', values: { basic: false, growth: false, premium: true } },
        { label: 'Comprehensive brand guideline document', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 3 revision rounds', values: { basic: false, growth: false, premium: true } },
        { label: 'Complete final-file package', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
  ...
  'photography': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$599', description: 'Businesses creating marketing content.', includes: ['Up to 2.5 hours', 'Up to 30 edited photographs', 'Product/team/location combinations', 'Enhanced retouching', 'Web and high-resolution files', 'Basic shot planning'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 1 hour on location', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 10 edited final photographs', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic color correction', values: { basic: true, growth: true, premium: true } },
        { label: 'Web-resolution files', values: { basic: true, growth: true, premium: true } },
        { label: 'One local location', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2.5 hours', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 30 edited photographs', values: { basic: false, growth: true, premium: true } },
        { label: 'Product/team/location combinations', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced retouching', values: { basic: false, growth: true, premium: true } },
        { label: 'Web and high-resolution files', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic shot planning', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to half-day shoot', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 60 edited photographs', values: { basic: false, growth: false, premium: true } },
        { label: 'Pre-shoot planning', values: { basic: false, growth: false, premium: true } },
        { label: 'Multiple setups', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced retouching', values: { basic: false, growth: false, premium: true } },
        { label: 'Organized image library', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
  ...
  'website-development': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 5 core website pages', values: { basic: true, growth: true, premium: true } },
        { label: 'Custom homepage design', values: { basic: true, growth: true, premium: true } },
        { label: 'Mobile and tablet responsive design', values: { basic: true, growth: true, premium: true } },
        { label: 'Contact form', values: { basic: true, growth: true, premium: true } },
        { label: 'Click-to-call and email functionality', values: { basic: true, growth: true, premium: true } },
        { label: 'Social media links', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic on-page SEO setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Page titles and meta descriptions', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic image optimization', values: { basic: true, growth: true, premium: true } },
        { label: 'Google Analytics setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Google Search Console setup', values: { basic: true, growth: true, premium: true } },
        { label: 'SSL configuration assistance', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic speed optimization', values: { basic: true, growth: true, premium: true } },
        { label: 'One primary conversion CTA', values: { basic: true, growth: true, premium: true } },
        { label: 'Two revision rounds', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic launch support', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 10 pages', values: { basic: false, growth: true, premium: true } },
        { label: 'More customized page layouts', values: { basic: false, growth: true, premium: true } },
        { label: 'Blog or resource section', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 lead-generation forms', values: { basic: false, growth: true, premium: true } },
        { label: 'Thank-you page', values: { basic: false, growth: true, premium: true } },
        { label: 'CRM or email platform connection', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic conversion tracking', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced on-page SEO', values: { basic: false, growth: true, premium: true } },
        { label: 'Internal linking setup', values: { basic: false, growth: true, premium: true } },
        { label: 'XML sitemap configuration', values: { basic: false, growth: true, premium: true } },
        { label: 'Robots.txt configuration', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic schema implementation where appropriate', values: { basic: false, growth: true, premium: true } },
        { label: 'Website analytics configuration', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic lead funnel structure', values: { basic: false, growth: true, premium: true } },
        { label: 'Three revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'CMS training session', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 20 pages', values: { basic: false, growth: false, premium: true } },
        { label: 'Custom UX/UI direction', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced page layouts', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion-focused page architecture', values: { basic: false, growth: false, premium: true } },
        { label: 'Multiple service or location pages', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 5 lead-generation forms', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced CRM/form integrations', values: { basic: false, growth: false, premium: true } },
        { label: 'Marketing automation connection', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced analytics and conversion tracking', values: { basic: false, growth: false, premium: true } },
        { label: 'Enhanced technical SEO setup', values: { basic: false, growth: false, premium: true } },
        { label: 'Custom website components', values: { basic: false, growth: false, premium: true } },
        { label: 'Resource/download functionality', values: { basic: false, growth: false, premium: true } },
        { label: 'Basic booking or scheduling integration', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced site navigation', values: { basic: false, growth: false, premium: true } },
        { label: 'Staging environment', values: { basic: false, growth: false, premium: true } },
        { label: 'Three revision rounds per major design phase', values: { basic: false, growth: false, premium: true } },
        { label: 'Team training', values: { basic: false, growth: false, premium: true } },
        { label: 'Post-launch review', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
  ...
  'landing-pages': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$899', description: 'Businesses running campaigns that need more than a single page.', includes: ['Up to 3 funnel pages', 'Landing page', 'Thank-you/confirmation page', 'Secondary conversion page', 'Lead form integration', 'CRM/email integration', 'Conversion tracking', 'Basic automation setup', 'Mobile optimization', 'A/B testing-ready structure', 'Up to 2 audience paths', 'Three revision rounds'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 custom landing page', values: { basic: true, growth: true, premium: true } },
        { label: 'Mobile responsive design', values: { basic: true, growth: true, premium: true } },
        { label: 'Lead capture form', values: { basic: true, growth: true, premium: true } },
        { label: 'Thank-you page', values: { basic: true, growth: true, premium: true } },
        { label: 'One primary CTA', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic conversion tracking', values: { basic: true, growth: true, premium: true } },
        { label: 'Email/CRM form connection', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic copy formatting', values: { basic: true, growth: true, premium: true } },
        { label: 'Two revision rounds', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 3 funnel pages', values: { basic: false, growth: true, premium: true } },
        { label: 'Landing page', values: { basic: false, growth: true, premium: true } },
        { label: 'Thank-you/confirmation page', values: { basic: false, growth: true, premium: true } },
        { label: 'Secondary conversion page', values: { basic: false, growth: true, premium: true } },
        { label: 'Lead form integration', values: { basic: false, growth: true, premium: true } },
        { label: 'CRM/email integration', values: { basic: false, growth: true, premium: true } },
        { label: 'Conversion tracking', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic automation setup', values: { basic: false, growth: true, premium: true } },
        { label: 'Mobile optimization', values: { basic: false, growth: true, premium: true } },
        { label: 'A/B testing-ready structure', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 audience paths', values: { basic: false, growth: true, premium: true } },
        { label: 'Three revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 6 funnel pages', values: { basic: false, growth: false, premium: true } },
        { label: 'Custom conversion-focused design', values: { basic: false, growth: false, premium: true } },
        { label: 'Lead capture system', values: { basic: false, growth: false, premium: true } },
        { label: 'Booking or checkout integration', values: { basic: false, growth: false, premium: true } },
        { label: 'CRM integration', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 5 automated follow-up emails', values: { basic: false, growth: false, premium: true } },
        { label: 'Analytics setup', values: { basic: false, growth: false, premium: true } },
        { label: 'Basic funnel automation', values: { basic: false, growth: false, premium: true } },
        { label: 'Lead tagging/segmentation', values: { basic: false, growth: false, premium: true } },
        { label: 'Thank-you and next-step flows', values: { basic: false, growth: false, premium: true } },
        { label: 'A/B test configuration for one key page', values: { basic: false, growth: false, premium: true } },
        { label: 'Funnel walkthrough', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$899', packageName: 'Growth Package', shortDescription: 'Up to 3 funnel pages, CRM/email integration', description: 'Businesses running campaigns that need more than a single page.', deliveryLabel: 'Shown during service selection', revisions: 'Three revision rounds', includes: ['Up to 3 funnel pages', 'Landing page', 'Thank-you/confirmation page', 'Secondary conversion page', 'Lead form integration', 'CRM/email integration', 'Conversion tracking', 'Basic automation setup', 'Mobile optimization', 'A/B testing-ready structure', 'Up to 2 audience paths', 'Three revision rounds'] },
  ...
  'ecommerce-development': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Store setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 10 products', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 5 informational pages', values: { basic: true, growth: true, premium: true } },
        { label: 'Mobile responsive design', values: { basic: true, growth: true, premium: true } },
        { label: 'Product category setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Shopping cart', values: { basic: true, growth: true, premium: true } },
        { label: 'Checkout configuration', values: { basic: true, growth: true, premium: true } },
        { label: 'One payment gateway', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic shipping configuration', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic tax settings', values: { basic: true, growth: true, premium: true } },
        { label: 'Order notification setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Google Analytics', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic SEO setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Two revision rounds', values: { basic: true, growth: true, premium: true } },
        { label: 'Store management training', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 50 products', values: { basic: false, growth: true, premium: true } },
        { label: 'Advanced product variations', values: { basic: false, growth: true, premium: true } },
        { label: 'Coupon/discount functionality', values: { basic: false, growth: true, premium: true } },
        { label: 'Abandoned-cart setup where supported', values: { basic: false, growth: true, premium: true } },
        { label: 'Email marketing integration', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced analytics', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced product SEO', values: { basic: false, growth: true, premium: true } },
        { label: 'Customer account functionality', values: { basic: false, growth: true, premium: true } },
        { label: 'Review functionality', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 payment gateways', values: { basic: false, growth: true, premium: true } },
        { label: 'Advanced shipping rules', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic product-data import', values: { basic: false, growth: true, premium: true } },
        { label: 'Three revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 150 initial products', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced product/category structure', values: { basic: false, growth: false, premium: true } },
        { label: 'Custom storefront components', values: { basic: false, growth: false, premium: true } },
        { label: 'Enhanced checkout configuration', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced conversion tracking', values: { basic: false, growth: false, premium: true } },
        { label: 'CRM integration', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced email automation', values: { basic: false, growth: false, premium: true } },
        { label: 'Subscription functionality where platform-supported', values: { basic: false, growth: false, premium: true } },
        { label: 'Multi-location or advanced inventory configuration where supported', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced shipping logic', values: { basic: false, growth: false, premium: true } },
        { label: 'Data migration assistance', values: { basic: false, growth: false, premium: true } },
        { label: 'Custom reporting configuration', values: { basic: false, growth: false, premium: true } },
        { label: 'Team training', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$2,999', packageName: 'Growth Package', shortDescription: 'Store with up to 50 products, coupons, customer accounts', description: 'Established businesses expanding online sales.', deliveryLabel: 'Shown during service selection', revisions: 'Three revision rounds', includes: ['Everything in Starter', 'Up to 50 products', 'Advanced product variations', 'Coupon/discount functionality', 'Abandoned-cart setup where supported', 'Email marketing integration', 'Enhanced analytics', 'Enhanced product SEO', 'Customer account functionality', 'Review functionality', 'Up to 2 payment gateways', 'Advanced shipping rules', 'Basic product-data import', 'Three revision rounds'] },
        premium: { price: '$5,999', packageName: 'Premium Package', shortDescription: 'Store with up to 150 products, custom storefront, CRM', description: 'Businesses requiring a more advanced commerce environment.', deliveryLabel: 'Shown during service selection', revisions: null, includes: ['Everything in Growth', 'Up to 150 initial products', 'Advanced product/category structure', 'Custom storefront components', 'Enhanced checkout configuration', 'Advanced conversion tracking', 'CRM integration', 'Advanced email automation', 'Subscription functionality where platform-supported', 'Multi-location or advanced inventory configuration where supported', 'Advanced shipping logic', 'Data migration assistance', 'Custom reporting configuration', 'Team training'] }
      }
    },
    sampleProject: {
  ...
  'web-applications': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Application', price: '$11,999', description: 'Businesses building more advanced digital systems.', includes: ['Product planning', 'Up to 15 core screens', 'Up to 2 user roles', 'Advanced database structure', 'Admin dashboard', 'Up to 3 integrations', 'Notification functionality', 'User-account management', 'Responsive application', 'QA testing', 'Deployment', 'Documentation', 'Team handoff'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Requirements workshop', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic product architecture', values: { basic: true, growth: true, premium: true } },
        { label: 'User authentication', values: { basic: true, growth: true, premium: true } },
        { label: '1 primary user role', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 5 core application screens', values: { basic: true, growth: true, premium: true } },
        { label: 'Database setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic admin functionality', values: { basic: true, growth: true, premium: true } },
        { label: '1 third-party integration', values: { basic: true, growth: true, premium: true } },
        { label: 'Responsive interface', values: { basic: true, growth: true, premium: true } },
        { label: 'Testing', values: { basic: true, growth: true, premium: true } },
        { label: 'Deployment assistance', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic technical documentation', values: { basic: true, growth: true, premium: true } },
        { label: 'Product planning', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 15 core screens', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 user roles', values: { basic: false, growth: true, premium: true } },
        { label: 'Advanced database structure', values: { basic: false, growth: true, premium: true } },
        { label: 'Admin dashboard', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 3 integrations', values: { basic: false, growth: true, premium: true } },
        { label: 'Notification functionality', values: { basic: false, growth: true, premium: true } },
        { label: 'User-account management', values: { basic: false, growth: true, premium: true } },
        { label: 'Responsive application', values: { basic: false, growth: true, premium: true } },
        { label: 'QA testing', values: { basic: false, growth: true, premium: true } },
        { label: 'Deployment', values: { basic: false, growth: true, premium: true } },
        { label: 'Documentation', values: { basic: false, growth: true, premium: true } },
        { label: 'Team handoff', values: { basic: false, growth: true, premium: true } },
        { label: 'Complex product architecture', values: { basic: false, growth: false, premium: true } },
        { label: 'Multiple user roles', values: { basic: false, growth: false, premium: true } },
        { label: 'Subscription/billing systems', values: { basic: false, growth: false, premium: true } },
        { label: 'Custom dashboards', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced database architecture', values: { basic: false, growth: false, premium: true } },
        { label: 'API integrations', values: { basic: false, growth: false, premium: true } },
        { label: 'Automated workflows', values: { basic: false, growth: false, premium: true } },
        { label: 'Role-based permissions', values: { basic: false, growth: false, premium: true } },
        { label: 'Reporting', values: { basic: false, growth: false, premium: true } },
        { label: 'Notifications', values: { basic: false, growth: false, premium: true } },
        { label: 'Staging/production environments', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced QA', values: { basic: false, growth: false, premium: true } },
        { label: 'Technical documentation', values: { basic: false, growth: false, premium: true } },
        { label: 'Post-launch support', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$11,999', packageName: 'Growth Application', shortDescription: 'Up to 15 core screens, up to 2 user roles, admin dashboard', description: 'Businesses building more advanced digital systems.', deliveryLabel: 'Shown during service selection', revisions: null, includes: ['Product planning', 'Up to 15 core screens', 'Up to 2 user roles', 'Advanced database structure', 'Admin dashboard', 'Up to 3 integrations', 'Notification functionality', 'User-account management', 'Responsive application', 'QA testing', 'Deployment', 'Documentation', 'Team handoff'] },
  ...
  'api-integration': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$1,299', description: 'Growth Integration.', includes: ['Integration of up to 2 systems', 'Up to 6 endpoints/actions', 'Advanced data mapping', 'Workflow logic', 'Error logging', 'Testing environment', 'Documentation', 'Deployment assistance'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 straightforward system integration', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2 API endpoints/actions', values: { basic: true, growth: true, premium: true } },
        { label: 'Authentication configuration', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic data mapping', values: { basic: true, growth: true, premium: true } },
        { label: 'Testing', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic error handling', values: { basic: true, growth: true, premium: true } },
        { label: 'Documentation', values: { basic: true, growth: true, premium: true } },
        { label: 'Integration of up to 2 systems', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 6 endpoints/actions', values: { basic: false, growth: true, premium: true } },
        { label: 'Advanced data mapping', values: { basic: false, growth: true, premium: true } },
        { label: 'Workflow logic', values: { basic: false, growth: true, premium: true } },
        { label: 'Error logging', values: { basic: false, growth: true, premium: true } },
        { label: 'Testing environment', values: { basic: false, growth: true, premium: true } },
        { label: 'Deployment assistance', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 3 interconnected systems', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 15 endpoints/actions', values: { basic: false, growth: false, premium: true } },
        { label: 'Complex workflow logic', values: { basic: false, growth: false, premium: true } },
        { label: 'Data transformations', values: { basic: false, growth: false, premium: true } },
        { label: 'Authentication/security configuration', values: { basic: false, growth: false, premium: true } },
        { label: 'Error handling and logging', values: { basic: false, growth: false, premium: true } },
        { label: 'Deployment support', values: { basic: false, growth: false, premium: true } },
        { label: 'Technical documentation', values: { basic: false, growth: false, premium: true } },
        { label: 'Post-launch review', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$1,299', packageName: 'Growth Package', shortDescription: 'Up to 2 systems, up to 6 endpoints, workflow logic', description: 'Growth Integration.', deliveryLabel: 'Shown during service selection', revisions: null, includes: ['Integration of up to 2 systems', 'Up to 6 endpoints/actions', 'Advanced data mapping', 'Workflow logic', 'Error logging', 'Testing environment', 'Documentation', 'Deployment assistance'] },
  ...
  'website-maintenance': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Care', price: '$349/month', description: 'Up to 5 support hours per month.', includes: ['Up to 5 support hours per month', 'Updates', 'Backup monitoring', 'Uptime monitoring', 'Content changes', 'Minor design adjustments', 'Basic speed review', 'Form/function testing', 'Priority support', 'Monthly maintenance report'] },
      premium: { name: 'Premium Care', price: '$799/month', description: 'Up to 10 support hours per month.', includes: ['Up to 10 support hours per month', 'Everything in Growth', 'Priority issue handling', 'Regular site health review', 'Conversion-form testing', 'Analytics review', 'Minor page creation', 'Minor development work', 'Monthly strategy recommendations'] }
    },
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 2 hours of website work per month', values: { basic: true, growth: true, premium: true } },
        { label: 'Core/plugin updates where applicable', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic backup monitoring', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic uptime checks', values: { basic: true, growth: true, premium: true } },
        { label: 'Minor content edits', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic technical health review', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly maintenance summary', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 5 support hours per month', values: { basic: false, growth: true, premium: true } },
        { label: 'Updates', values: { basic: false, growth: true, premium: true } },
        { label: 'Backup monitoring', values: { basic: false, growth: true, premium: true } },
        { label: 'Uptime monitoring', values: { basic: false, growth: true, premium: true } },
        { label: 'Content changes', values: { basic: false, growth: true, premium: true } },
        { label: 'Minor design adjustments', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic speed review', values: { basic: false, growth: true, premium: true } },
        { label: 'Form/function testing', values: { basic: false, growth: true, premium: true } },
        { label: 'Priority support', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly maintenance report', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 10 support hours per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Priority issue handling', values: { basic: false, growth: false, premium: true } },
        { label: 'Regular site health review', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion-form testing', values: { basic: false, growth: false, premium: true } },
        { label: 'Analytics review', values: { basic: false, growth: false, premium: true } },
        { label: 'Minor page creation', values: { basic: false, growth: false, premium: true } },
        { label: 'Minor development work', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly strategy recommendations', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$349/month', packageName: 'Growth Care', shortDescription: 'Up to 5 hours maintenance, content updates', description: 'Up to 5 support hours per month.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Up to 5 support hours per month', 'Updates', 'Backup monitoring', 'Uptime monitoring', 'Content changes', 'Minor design adjustments', 'Basic speed review', 'Form/function testing', 'Priority support', 'Monthly maintenance report'] },
        premium: { price: '$799/month', packageName: 'Premium Care', shortDescription: 'Up to 10 hours maintenance, priority support', description: 'Up to 10 support hours per month.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Up to 10 support hours per month', 'Everything in Growth', 'Priority issue handling', 'Regular site health review', 'Conversion-form testing', 'Analytics review', 'Minor page creation', 'Minor development work', 'Monthly strategy recommendations'] }
      }
    },
    sampleProject: {
  ...
  'online-booking-systems': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Calendar integration', values: { basic: true, growth: true, premium: true } },
        { label: 'Email notifications', values: { basic: true, growth: true, premium: true } },
        { label: 'Mobile-friendly booking form', values: { basic: true, growth: true, premium: true } },
        { label: 'Automated reminders', values: { basic: false, growth: true, premium: true } },
        { label: 'Payment integration', values: { basic: false, growth: true, premium: true } },
        { label: 'Multi-location support', values: { basic: false, growth: false, premium: true } },
        { label: 'CRM integration', values: { basic: false, growth: false, premium: true } }
      ],
      details: {
  ...
  'social-media-management': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 social platform', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 8 feed posts per month', values: { basic: true, growth: true, premium: true } },
        { label: 'Caption writing', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic graphic creation', values: { basic: true, growth: true, premium: true } },
        { label: 'Hashtag/topic research where relevant', values: { basic: true, growth: true, premium: true } },
        { label: 'Content scheduling', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly content calendar', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic monthly report', values: { basic: true, growth: true, premium: true } },
        { label: 'One revision round on the monthly content batch', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2 platforms', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 16 feed posts per month', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 4 short-form videos/reels using provided or existing footage', values: { basic: false, growth: true, premium: true } },
        { label: 'Graphic design', values: { basic: false, growth: true, premium: true } },
        { label: 'Scheduling', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic community-response support', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly analytics', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly strategy review', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 3 platforms', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 24 feed posts per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 8 short-form videos', values: { basic: false, growth: false, premium: true } },
        { label: 'Content calendar', values: { basic: false, growth: false, premium: true } },
        { label: 'Caption/copy development', values: { basic: false, growth: false, premium: true } },
        { label: 'Basic weekday community management', values: { basic: false, growth: false, premium: true } },
        { label: 'Social listening', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly campaign planning', values: { basic: false, growth: false, premium: true } },
        { label: 'Performance reporting', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly strategy call', values: { basic: false, growth: false, premium: true } },
        { label: 'Ongoing optimization', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$699/month', packageName: 'Growth Package', shortDescription: '2 platforms, 16 posts/month, short-form videos', description: 'Growth tier social media management.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Up to 2 platforms', 'Up to 16 feed posts per month', 'Up to 4 short-form videos/reels using provided or existing footage', 'Caption writing', 'Graphic design', 'Monthly content calendar', 'Scheduling', 'Basic community-response support', 'Monthly analytics', 'Monthly strategy review'] },
  ...
  'seo-marketing': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$999/month', description: 'Most Popular — everything in Starter, plus expanded keyword tracking and content.', includes: ['Everything in Starter', 'Up to 20 tracked target keywords', 'Optimization across up to 15 priority pages', 'Competitor SEO review', 'Two SEO-focused content pieces or substantial content optimizations per month', 'Enhanced internal-link strategy', 'Technical issue monitoring', 'Search intent analysis', 'Content-gap analysis', 'Local SEO optimization when applicable', 'Google Business Profile recommendations when applicable', 'Basic structured-data recommendations', 'Conversion-page SEO review', 'Monthly strategy review'] },
      premium: { name: 'Premium Package', price: '$1,999/month', description: 'Businesses pursuing more aggressive organic Growth.', includes: ['Everything in Growth', 'Up to 40 tracked keywords', 'Up to 30 priority pages', 'Up to 4 SEO content pieces or major optimizations per month', 'Advanced competitor research', 'Advanced content-gap analysis', 'Technical SEO monitoring', 'Schema strategy', 'Multi-service or multi-location SEO strategy', 'Content-cluster planning', 'Link opportunity research and outreach strategy', 'Conversion optimization recommendations', 'Priority implementation support', 'Monthly strategy call', 'Detailed executive reporting'] }
    },
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Initial SEO audit', values: { basic: true, growth: true, premium: true } },
        { label: 'Keyword research for up to 10 target keywords', values: { basic: true, growth: true, premium: true } },
        { label: 'Optimization of up to 5 priority pages', values: { basic: true, growth: true, premium: true } },
        { label: 'Page title optimization', values: { basic: true, growth: true, premium: true } },
        { label: 'Meta description optimization', values: { basic: true, growth: true, premium: true } },
        { label: 'Heading structure review', values: { basic: true, growth: true, premium: true } },
        { label: 'Internal-link improvements', values: { basic: true, growth: true, premium: true } },
        { label: 'Google Search Console review', values: { basic: true, growth: true, premium: true } },
        { label: 'Google Analytics review', values: { basic: true, growth: true, premium: true } },
        { label: 'XML sitemap review', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic technical SEO checks', values: { basic: true, growth: true, premium: true } },
        { label: 'One existing page/content optimization per month', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly ranking review', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly performance report', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly recommendations', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 20 tracked target keywords', values: { basic: false, growth: true, premium: true } },
        { label: 'Optimization across up to 15 priority pages', values: { basic: false, growth: true, premium: true } },
        { label: 'Competitor SEO review', values: { basic: false, growth: true, premium: true } },
        { label: 'Two SEO-focused content pieces or substantial content optimizations per month', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced internal-link strategy', values: { basic: false, growth: true, premium: true } },
        { label: 'Technical issue monitoring', values: { basic: false, growth: true, premium: true } },
        { label: 'Search intent analysis', values: { basic: false, growth: true, premium: true } },
        { label: 'Content-gap analysis', values: { basic: false, growth: true, premium: true } },
        { label: 'Local SEO optimization when applicable', values: { basic: false, growth: true, premium: true } },
        { label: 'Google Business Profile recommendations when applicable', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic structured-data recommendations', values: { basic: false, growth: true, premium: true } },
        { label: 'Conversion-page SEO review', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly strategy review', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 40 tracked keywords', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 30 priority pages', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 4 SEO content pieces or major optimizations per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced competitor research', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced content-gap analysis', values: { basic: false, growth: false, premium: true } },
        { label: 'Technical SEO monitoring', values: { basic: false, growth: false, premium: true } },
        { label: 'Schema strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'Multi-service or multi-location SEO strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'Content-cluster planning', values: { basic: false, growth: false, premium: true } },
        { label: 'Link opportunity research and outreach strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion optimization recommendations', values: { basic: false, growth: false, premium: true } },
        { label: 'Priority implementation support', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly strategy call', values: { basic: false, growth: false, premium: true } },
        { label: 'Detailed executive reporting', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$999/month', packageName: 'Growth Package', shortDescription: '20 keywords, optimization of 15 pages, content pieces', description: 'Most Popular — everything in Starter, plus expanded keyword tracking and content.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Everything in Starter', 'Up to 20 tracked target keywords', 'Optimization across up to 15 priority pages', 'Competitor SEO review', 'Two SEO-focused content pieces or substantial content optimizations per month', 'Enhanced internal-link strategy', 'Technical issue monitoring', 'Search intent analysis', 'Content-gap analysis', 'Local SEO optimization when applicable', 'Google Business Profile recommendations when applicable', 'Basic structured-data recommendations', 'Conversion-page SEO review', 'Monthly strategy review'] },
        premium: { price: '$1,999/month', packageName: 'Premium Package', shortDescription: '40 keywords, 30 pages, schema & outreach strategy', description: 'Businesses pursuing more aggressive organic Growth.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Everything in Growth', 'Up to 40 tracked keywords', 'Up to 30 priority pages', 'Up to 4 SEO content pieces or major optimizations per month', 'Advanced competitor research', 'Advanced content-gap analysis', 'Technical SEO monitoring', 'Schema strategy', 'Multi-service or multi-location SEO strategy', 'Content-cluster planning', 'Link opportunity research and outreach strategy', 'Conversion optimization recommendations', 'Priority implementation support', 'Monthly strategy call', 'Detailed executive reporting'] }
      }
    },
    sampleProject: {
  ...
  'paid-advertising': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 advertising platform', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 1 active campaign', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 3 ad groups/ad sets', values: { basic: true, growth: true, premium: true } },
        { label: 'Initial campaign setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic keyword or audience research', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 6 ad variations', values: { basic: true, growth: true, premium: true } },
        { label: 'Conversion tracking setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Budget monitoring', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic optimization', values: { basic: true, growth: true, premium: true } },
        { label: 'Negative keyword management where applicable', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly report', values: { basic: true, growth: true, premium: true } },
        { label: 'One monthly campaign review', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2 active campaigns', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 8 ad groups/ad sets', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 12 active ad variations', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced audience/keyword research', values: { basic: false, growth: true, premium: true } },
        { label: 'Retargeting campaign setup', values: { basic: false, growth: true, premium: true } },
        { label: 'Landing-page recommendations', values: { basic: false, growth: true, premium: true } },
        { label: 'Weekly optimization', values: { basic: false, growth: true, premium: true } },
        { label: 'Search-term analysis', values: { basic: false, growth: true, premium: true } },
        { label: 'Bid/budget adjustments', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic creative testing', values: { basic: false, growth: true, premium: true } },
        { label: 'Conversion-performance analysis', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly strategy call', values: { basic: false, growth: true, premium: true } },
        { label: 'Multi-campaign management', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 2 advertising platforms', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced audience segmentation', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced retargeting', values: { basic: false, growth: false, premium: true } },
        { label: 'Creative testing', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion tracking', values: { basic: false, growth: false, premium: true } },
        { label: 'Funnel performance analysis', values: { basic: false, growth: false, premium: true } },
        { label: 'Weekly performance monitoring', values: { basic: false, growth: false, premium: true } },
        { label: 'Budget allocation recommendations', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced keyword/search-term management', values: { basic: false, growth: false, premium: true } },
        { label: 'Executive reporting', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$799/month', packageName: 'Growth Package', shortDescription: 'Up to 2 campaigns, retargeting, weekly optimization', description: 'Everything in Starter, plus more campaigns and testing.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Everything in Starter', 'Up to 2 active campaigns', 'Up to 8 ad groups/ad sets', 'Up to 12 active ad variations', 'Enhanced audience/keyword research', 'Retargeting campaign setup', 'Landing-page recommendations', 'Weekly optimization', 'Search-term analysis', 'Bid/budget adjustments', 'Basic creative testing', 'Conversion-performance analysis', 'Monthly strategy call'] },
  ...
  'email-marketing': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$599', description: 'Growth Campaign.', includes: ['Up to 4 emails', 'Campaign strategy', 'Email layout/design', 'Subject-line development', 'Basic copywriting', 'Audience segmentation', 'CTA strategy', 'UTM/tracking setup', 'Scheduling', 'Basic automation', 'Performance report', 'Two revision rounds'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 email campaign', values: { basic: true, growth: true, premium: true } },
        { label: 'Email layout/design', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic copy editing', values: { basic: true, growth: true, premium: true } },
        { label: 'CTA setup', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic segmentation', values: { basic: true, growth: true, premium: true } },
        { label: 'Links and tracking', values: { basic: true, growth: true, premium: true } },
        { label: 'Test send', values: { basic: true, growth: true, premium: true } },
        { label: 'Mobile review', values: { basic: true, growth: true, premium: true } },
        { label: 'One revision round', values: { basic: true, growth: true, premium: true } },
        { label: 'Campaign performance summary', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 4 emails', values: { basic: false, growth: true, premium: true } },
        { label: 'Campaign strategy', values: { basic: false, growth: true, premium: true } },
        { label: 'Subject-line development', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic copywriting', values: { basic: false, growth: true, premium: true } },
        { label: 'Audience segmentation', values: { basic: false, growth: true, premium: true } },
        { label: 'CTA strategy', values: { basic: false, growth: true, premium: true } },
        { label: 'UTM/tracking setup', values: { basic: false, growth: true, premium: true } },
        { label: 'Scheduling', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic automation', values: { basic: false, growth: true, premium: true } },
        { label: 'Performance report', values: { basic: false, growth: true, premium: true } },
        { label: 'Two revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 8 emails', values: { basic: false, growth: false, premium: true } },
        { label: 'Full campaign strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'Copywriting', values: { basic: false, growth: false, premium: true } },
        { label: 'Design/layout', values: { basic: false, growth: false, premium: true } },
        { label: 'Segmentation strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'Automated email flow', values: { basic: false, growth: false, premium: true } },
        { label: 'Lead tagging', values: { basic: false, growth: false, premium: true } },
        { label: 'Basic A/B testing', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion tracking', values: { basic: false, growth: false, premium: true } },
        { label: 'Performance analysis', values: { basic: false, growth: false, premium: true } },
        { label: 'Optimization recommendations', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$599', packageName: 'Growth Package', shortDescription: 'Up to 4 emails, campaign strategy, 2 revisions', description: 'Growth Campaign.', deliveryLabel: 'Shown during service selection', revisions: 'Two revision rounds', includes: ['Up to 4 emails', 'Campaign strategy', 'Email layout/design', 'Subject-line development', 'Basic copywriting', 'Audience segmentation', 'CTA strategy', 'UTM/tracking setup', 'Scheduling', 'Basic automation', 'Performance report', 'Two revision rounds'] },
  ...
  'lead-generation': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$699/month', description: 'Growth Lead Generation.', includes: ['Everything in Starter', 'Up to 500 prospect records per month', 'Multiple target segments', 'Enhanced prospect research', 'Up to 2 outreach sequences', 'Basic personalization framework', 'CRM import assistance', 'Lead tagging', 'Follow-up workflow', 'Monthly performance analysis', 'Strategy adjustments'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Ideal customer profile definition', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic target-market research', values: { basic: true, growth: true, premium: true } },
        { label: 'Prospecting criteria', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 150 prospect records per month', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic lead-list organization', values: { basic: true, growth: true, premium: true } },
        { label: 'Contact-data cleanup', values: { basic: true, growth: true, premium: true } },
        { label: 'One outreach sequence framework', values: { basic: true, growth: true, premium: true } },
        { label: 'Lead tracking sheet or basic CRM structure', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly results summary', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 500 prospect records per month', values: { basic: false, growth: true, premium: true } },
        { label: 'Multiple target segments', values: { basic: false, growth: true, premium: true } },
        { label: 'Enhanced prospect research', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 outreach sequences', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic personalization framework', values: { basic: false, growth: true, premium: true } },
        { label: 'CRM import assistance', values: { basic: false, growth: true, premium: true } },
        { label: 'Lead tagging', values: { basic: false, growth: true, premium: true } },
        { label: 'Follow-up workflow', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly performance analysis', values: { basic: false, growth: true, premium: true } },
        { label: 'Strategy adjustments', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 1,000 prospect records per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Multiple customer profiles', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced account research', values: { basic: false, growth: false, premium: true } },
        { label: 'Multi-step outreach strategy', values: { basic: false, growth: false, premium: true } },
        { label: 'CRM pipeline setup', values: { basic: false, growth: false, premium: true } },
        { label: 'Lead qualification framework', values: { basic: false, growth: false, premium: true } },
        { label: 'Follow-up automation', values: { basic: false, growth: false, premium: true } },
        { label: 'Reporting dashboard', values: { basic: false, growth: false, premium: true } },
        { label: 'Ongoing campaign refinement', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly strategy session', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$699/month', packageName: 'Growth Package', shortDescription: 'Up to 500 prospect records per month', description: 'Growth Lead Generation.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Everything in Starter', 'Up to 500 prospect records per month', 'Multiple target segments', 'Enhanced prospect research', 'Up to 2 outreach sequences', 'Basic personalization framework', 'CRM import assistance', 'Lead tagging', 'Follow-up workflow', 'Monthly performance analysis', 'Strategy adjustments'] },
  ...
  'reputation-review-management': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Review collection system', values: { basic: true, growth: true, premium: true } },
        { label: 'Review monitoring', values: { basic: true, growth: true, premium: true } },
        { label: 'Monthly report', values: { basic: true, growth: true, premium: true } },
        { label: 'Multi-platform monitoring', values: { basic: false, growth: true, premium: true } },
        { label: 'Custom response management', values: { basic: false, growth: true, premium: true } },
        { label: 'Automated review requests', values: { basic: false, growth: false, premium: true } },
        { label: 'Crisis response support', values: { basic: false, growth: false, premium: true } }
      ],
      details: {
  ...
  'crm-automation': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$1,299', description: 'Growth Automation.', includes: ['Up to 2 CRM pipelines', 'Up to 5 automated workflows', 'Up to 3 integrations', 'Lead routing', 'Email follow-up automation', 'Task automation', 'Contact segmentation', 'Pipeline stages', 'Basic dashboard', 'Testing and QA', 'Documentation', 'Team training'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: '1 CRM pipeline', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic CRM configuration', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2 forms', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 3 automated workflows', values: { basic: true, growth: true, premium: true } },
        { label: 'Contact tagging', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic lead notifications', values: { basic: true, growth: true, premium: true } },
        { label: '1 third-party integration', values: { basic: true, growth: true, premium: true } },
        { label: 'Testing', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic documentation', values: { basic: true, growth: true, premium: true } },
        { label: 'One training session', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2 CRM pipelines', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 5 automated workflows', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 3 integrations', values: { basic: false, growth: true, premium: true } },
        { label: 'Lead routing', values: { basic: false, growth: true, premium: true } },
        { label: 'Email follow-up automation', values: { basic: false, growth: true, premium: true } },
        { label: 'Task automation', values: { basic: false, growth: true, premium: true } },
        { label: 'Contact segmentation', values: { basic: false, growth: true, premium: true } },
        { label: 'Pipeline stages', values: { basic: false, growth: true, premium: true } },
        { label: 'Basic dashboard', values: { basic: false, growth: true, premium: true } },
        { label: 'Testing and QA', values: { basic: false, growth: true, premium: true } },
        { label: 'Documentation', values: { basic: false, growth: true, premium: true } },
        { label: 'Team training', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 4 pipelines', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 12 automated workflows', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 6 integrations', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced lead routing', values: { basic: false, growth: false, premium: true } },
        { label: 'Multi-step customer journeys', values: { basic: false, growth: false, premium: true } },
        { label: 'Sales automation', values: { basic: false, growth: false, premium: true } },
        { label: 'Marketing automation', values: { basic: false, growth: false, premium: true } },
        { label: 'Customer tagging/scoring rules', values: { basic: false, growth: false, premium: true } },
        { label: 'Reporting dashboard', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced workflow testing', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 2 hours of team training', values: { basic: false, growth: false, premium: true } },
        { label: 'Post-launch optimization review', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$1,299', packageName: 'Growth Package', shortDescription: 'Up to 2 pipelines, up to 5 workflows, lead routing', description: 'Growth Automation.', deliveryLabel: 'Shown during service selection', revisions: null, includes: ['Up to 2 CRM pipelines', 'Up to 5 automated workflows', 'Up to 3 integrations', 'Lead routing', 'Email follow-up automation', 'Task automation', 'Contact segmentation', 'Pipeline stages', 'Basic dashboard', 'Testing and QA', 'Documentation', 'Team training'] },
  ...
  'business-process-automation': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Automated workflows', values: { basic: true, growth: true, premium: true } },
        { label: 'Process mapping', values: { basic: true, growth: true, premium: true } },
        { label: 'Testing and documentation', values: { basic: true, growth: true, premium: true } },
        { label: 'Integration setup', values: { basic: false, growth: true, premium: true } },
        { label: 'Training support', values: { basic: false, growth: true, premium: true } },
        { label: 'Multi-system integration', values: { basic: false, growth: false, premium: true } },
        { label: 'Ongoing support', values: { basic: false, growth: false, premium: true } }
      ],
      details: {
  ...
  'data-analytics': {
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$699/month', description: 'Growth Analytics.', includes: ['Up to 3 regular data sources', 'Monthly dashboard updates', 'KPI tracking', 'Trend analysis', 'Monthly performance report', 'Data-quality review', 'Recommendations', 'One monthly review meeting'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 1 primary data source', values: { basic: true, growth: true, premium: true } },
        { label: 'Data cleanup for the agreed dataset', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 8 key metrics', values: { basic: true, growth: true, premium: true } },
        { label: 'One basic dashboard/report', values: { basic: true, growth: true, premium: true } },
        { label: 'Key observations', values: { basic: true, growth: true, premium: true } },
        { label: 'One revision round', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 3 regular data sources', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly dashboard updates', values: { basic: false, growth: true, premium: true } },
        { label: 'KPI tracking', values: { basic: false, growth: true, premium: true } },
        { label: 'Trend analysis', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly performance report', values: { basic: false, growth: true, premium: true } },
        { label: 'Data-quality review', values: { basic: false, growth: true, premium: true } },
        { label: 'Recommendations', values: { basic: false, growth: true, premium: true } },
        { label: 'One monthly review meeting', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 5 regular data sources', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced dashboards', values: { basic: false, growth: false, premium: true } },
        { label: 'Department/channel segmentation', values: { basic: false, growth: false, premium: true } },
        { label: 'KPI framework', values: { basic: false, growth: false, premium: true } },
        { label: 'Conversion/performance analysis', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly executive report', values: { basic: false, growth: false, premium: true } },
        { label: 'Regular dashboard refreshes', values: { basic: false, growth: false, premium: true } },
        { label: 'Monthly strategy meeting', values: { basic: false, growth: false, premium: true } },
        { label: 'Improvement recommendations', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$699/month', packageName: 'Growth Package', shortDescription: 'Up to 3 data sources, monthly dashboard updates', description: 'Growth Analytics.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Up to 3 regular data sources', 'Monthly dashboard updates', 'KPI tracking', 'Trend analysis', 'Monthly performance report', 'Data-quality review', 'Recommendations', 'One monthly review meeting'] },
  ...
  'business-consulting-Growth-strategy': {
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Strategy sessions', values: { basic: true, growth: true, premium: true } },
        { label: 'Business assessment', values: { basic: true, growth: true, premium: true } },
        { label: 'Action plan document', values: { basic: true, growth: true, premium: true } },
        { label: 'Implementation roadmap', values: { basic: false, growth: true, premium: true } },
        { label: 'Monthly progress reviews', values: { basic: false, growth: true, premium: true } },
        { label: 'Quarterly strategy reviews', values: { basic: false, growth: false, premium: true } },
        { label: 'Team support and implementation', values: { basic: false, growth: false, premium: true } }
      ],
      details: {
  ...
  'virtual-assistant': {
    ...
    complementaryServices: [
      ...
      { name: 'Process Documentation', reason: 'workflow growthization' },
    ...
    packages: {
      ...
      growth: { name: 'Growth VA', price: '$499/month', description: 'Up to 25 hours per month.', includes: ['Up to 25 hours per month', 'Everything in Starter', 'CRM updates', 'Customer follow-up support', 'Content scheduling', 'Reporting assistance', 'Process support', 'Recurring administrative workflows'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 10 hours per month', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic administrative tasks', values: { basic: true, growth: true, premium: true } },
        { label: 'Calendar support', values: { basic: true, growth: true, premium: true } },
        { label: 'Data organization', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic research', values: { basic: true, growth: true, premium: true } },
        { label: 'Document formatting', values: { basic: true, growth: true, premium: true } },
        { label: 'Routine email assistance', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 25 hours per month', values: { basic: false, growth: true, premium: true } },
        { label: 'CRM updates', values: { basic: false, growth: true, premium: true } },
        { label: 'Customer follow-up support', values: { basic: false, growth: true, premium: true } },
        { label: 'Content scheduling', values: { basic: false, growth: true, premium: true } },
        { label: 'Reporting assistance', values: { basic: false, growth: true, premium: true } },
        { label: 'Process support', values: { basic: false, growth: true, premium: true } },
        { label: 'Recurring administrative workflows', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 50 hours per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Advanced administrative support', values: { basic: false, growth: false, premium: true } },
        { label: 'CRM management', values: { basic: false, growth: false, premium: true } },
        { label: 'Customer-service support', values: { basic: false, growth: false, premium: true } },
        { label: 'Research', values: { basic: false, growth: false, premium: true } },
        { label: 'Reporting', values: { basic: false, growth: false, premium: true } },
        { label: 'Content administration', values: { basic: false, growth: false, premium: true } },
        { label: 'Project coordination', values: { basic: false, growth: false, premium: true } },
        { label: 'Recurring operations support', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$499/month', packageName: 'Growth VA', shortDescription: 'Up to 25 hours per month, CRM updates', description: 'Up to 25 hours per month.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Up to 25 hours per month', 'Everything in Starter', 'CRM updates', 'Customer follow-up support', 'Content scheduling', 'Reporting assistance', 'Process support', 'Recurring administrative workflows'] },
  ...
  'project-management': {
    ...
    packages: {
      ...
      growth: { name: 'Growth PM Support', price: '$1,199/month', description: 'Up to 25 hours per month.', includes: ['Up to 25 hours per month', 'Project planning', 'Task management', 'Team coordination', 'Risk/issue tracking', 'Weekly reporting', 'Meeting coordination', 'Documentation', 'Stakeholder updates'] },
    ...
    packageComparison: {
      ...
      rows: [
        { label: 'Up to 10 hours per month', values: { basic: true, growth: true, premium: true } },
        { label: 'Project tracking', values: { basic: true, growth: true, premium: true } },
        { label: 'Task organization', values: { basic: true, growth: true, premium: true } },
        { label: 'Deadline tracking', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic status reports', values: { basic: true, growth: true, premium: true } },
        { label: 'Team follow-up', values: { basic: true, growth: true, premium: true } },
        { label: 'One weekly coordination touchpoint', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 25 hours per month', values: { basic: false, growth: true, premium: true } },
        { label: 'Project planning', values: { basic: false, growth: true, premium: true } },
        { label: 'Task management', values: { basic: false, growth: true, premium: true } },
        { label: 'Team coordination', values: { basic: false, growth: true, premium: true } },
        { label: 'Risk/issue tracking', values: { basic: false, growth: true, premium: true } },
        { label: 'Weekly reporting', values: { basic: false, growth: true, premium: true } },
        { label: 'Meeting coordination', values: { basic: false, growth: true, premium: true } },
        { label: 'Documentation', values: { basic: false, growth: true, premium: true } },
        { label: 'Stakeholder updates', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 50 hours per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Multi-workstream coordination', values: { basic: false, growth: false, premium: true } },
        { label: 'Schedule management', values: { basic: false, growth: false, premium: true } },
        { label: 'Risk management', values: { basic: false, growth: false, premium: true } },
        { label: 'Stakeholder management', values: { basic: false, growth: false, premium: true } },
        { label: 'Project documentation', values: { basic: false, growth: false, premium: true } },
        { label: 'Leadership updates', values: { basic: false, growth: false, premium: true } },
        { label: 'Continuous project oversight', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$1,199/month', packageName: 'Growth PM Support', shortDescription: 'Up to 25 hours per month, project planning', description: 'Up to 25 hours per month.', deliveryLabel: 'Shown during service selection', revisions: 'Ongoing monthly', includes: ['Up to 25 hours per month', 'Project planning', 'Task management', 'Team coordination', 'Risk/issue tracking', 'Weekly reporting', 'Meeting coordination', 'Documentation', 'Stakeholder updates'] },
  ...
  'process-documentation': {
    ...
    whatItHelpsAchieve: ['growthize workflows and procedures', 'improve team efficiency', 'simplify employee training', 'reduce operational errors', 'create systems that support business Growth'],
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$999', description: 'Organizing multiple operational procedures.', includes: ['Up to 8 SOPs', 'Up to approximately 40 total finished pages', 'Process interviews', 'Workflow documentation', 'Roles/responsibilities', 'Templates/checklists where applicable', 'Growthized formatting', 'Two revision rounds'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 3 SOPs', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to approximately 15 total finished pages', values: { basic: true, growth: true, premium: true } },
        { label: 'Process review', values: { basic: true, growth: true, premium: true } },
        { label: 'Step-by-step documentation', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic formatting', values: { basic: true, growth: true, premium: true } },
        { label: 'One revision round', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 8 SOPs', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to approximately 40 total finished pages', values: { basic: false, growth: true, premium: true } },
        { label: 'Process interviews', values: { basic: false, growth: true, premium: true } },
        { label: 'Workflow documentation', values: { basic: false, growth: true, premium: true } },
        { label: 'Roles/responsibilities', values: { basic: false, growth: true, premium: true } },
        { label: 'Templates/checklists where applicable', values: { basic: false, growth: true, premium: true } },
        { label: 'Growthized formatting', values: { basic: false, growth: true, premium: true } },
        { label: 'Two revision rounds', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 20 SOPs', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to approximately 100 total finished pages', values: { basic: false, growth: false, premium: true } },
        { label: 'Stakeholder interviews', values: { basic: false, growth: false, premium: true } },
        { label: 'Process mapping', values: { basic: false, growth: false, premium: true } },
        { label: 'Roles and responsibility documentation', values: { basic: false, growth: false, premium: true } },
        { label: 'Operational checklists', values: { basic: false, growth: false, premium: true } },
        { label: 'Templates', values: { basic: false, growth: false, premium: true } },
        { label: 'Documentation structure', values: { basic: false, growth: false, premium: true } },
        { label: 'Implementation recommendations', values: { basic: false, growth: false, premium: true } },
        { label: 'Up to 3 revision rounds', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
  ...
  'data-entry': {
    ...
    complementaryServices: [
      ...
      { name: 'Process Documentation & SOP Development', reason: 'growthize workflows' },
    ...
    packages: {
      ...
      growth: { name: 'Growth Package', price: '$299', description: 'Businesses managing larger datasets.', includes: ['Up to 2,000 straightforward records', 'Data entry', 'Data cleanup', 'Formatting', 'Duplicate detection', 'Categorization', 'Quality review', 'Up to 2 output formats'] },
    ...
    packageComparison: {
      tiers: ['basic', 'growth', 'premium'],
      rows: [
        { label: 'Up to 500 straightforward records', values: { basic: true, growth: true, premium: true } },
        { label: 'Data entry', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic formatting', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic duplicate review', values: { basic: true, growth: true, premium: true } },
        { label: 'Basic quality check', values: { basic: true, growth: true, premium: true } },
        { label: 'One agreed data source/output format', values: { basic: true, growth: true, premium: true } },
        { label: 'Up to 2,000 straightforward records', values: { basic: false, growth: true, premium: true } },
        { label: 'Data cleanup', values: { basic: false, growth: true, premium: true } },
        { label: 'Formatting', values: { basic: false, growth: true, premium: true } },
        { label: 'Duplicate detection', values: { basic: false, growth: true, premium: true } },
        { label: 'Categorization', values: { basic: false, growth: true, premium: true } },
        { label: 'Quality review', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 2 output formats', values: { basic: false, growth: true, premium: true } },
        { label: 'Up to 5,000 straightforward records per month', values: { basic: false, growth: false, premium: true } },
        { label: 'Recurring processing', values: { basic: false, growth: false, premium: true } },
        { label: 'Quality-control checks', values: { basic: false, growth: false, premium: true } },
        { label: 'Regular status reporting', values: { basic: false, growth: false, premium: true } },
      ],
      details: {
        ...
        growth: { price: '$299', packageName: 'Growth Package', shortDescription: 'Up to 2,000 records, cleanup and categorization', description: 'Businesses managing larger datasets.', deliveryLabel: 'Shown during service selection', revisions: null, includes: ['Up to 2,000 straightforward records', 'Data entry', 'Data cleanup', 'Formatting', 'Duplicate detection', 'Categorization', 'Quality review', 'Up to 2 output formats'] },
