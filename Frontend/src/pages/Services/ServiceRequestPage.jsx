...
const RequestServicePage = () => {
  ...
  const [agreedToCustomEscrow, setAgreedToCustomEscrow] = useState(false);
                ...
                <>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border-2 border-blue-200 shadow-md">
                      ...
                      {totalAmount === 0 && (
                        <div className="mb-4 bg-slate-50 border border-slate-200 p-4 rounded-xl text-left">
                          ...
                          <label className="flex items-start gap-2 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={agreedToCustomEscrow}
                              onChange={e => setAgreedToCustomEscrow(e.target.checked)}
                              className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 mt-0.5"
                            />
                            <span className="text-xs font-semibold text-slate-700 leading-tight">
                      ...
                      <button type="button" onClick={handleProceedToPayment} disabled={isSubmitting || isLoadingRates || (totalAmount === 0 && !agreedToCustomEscrow)}
